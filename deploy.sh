...
rm -f pinshot_blue.*
popd > /dev/null
pushd ../AV-Bible/bin/Debug/net8.0-windows10.0.17763.0 > /dev/null
rm -f pinshot_blue.*
popd > /dev/null
...
cp target/debug/*.dll ../AV-Bible/bin/Debug/net8.0-windows10.0.17763.0
cp target/debug/*.pdb ../AV-Bible/bin/Debug/net8.0-windows10.0.17763.0
...
cp target/release/*.dll ../AV-Bible/bin/x64/Release/net8.0-windows10.0.17763.0
